        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="animate-fade-in-up">
            ...
            <p className="text-lg text-muted-foreground mb-6 leading-relaxed">
              Ethical hacker, consultant, and educator helping businesses stay secure in an increasingly digital world. 
              With over a decade of experience in cybersecurity, I've protected organizations from threats both old and new 
              (yes, even AI-powered ones).
            </p>
          ...
          <div className="grid grid-cols-1 gap-6 animate-fade-in-up [animation-delay:200ms]">
            {stats.map((stat, index) => {
              ...
              return (
                <div 
                  key={stat.label}
                  className="flex items-center gap-4 p-6 bg-card rounded-lg border border-border transition-smooth hover:shadow-card hover:scale-105"
